<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GridAndDetails.aspx.cs" Inherits="DataBindingIntro.GridAndDetails" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            Grid and Details Combo View<br />
            <br />
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="CustomerID" DataSourceID="SqlDataSource1" ForeColor="#333333" GridLines="None" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
